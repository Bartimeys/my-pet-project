...
angular.module('openWeatherApp.directives', [])
  ...
  //
  // Simple directive just setting version as elements value (kept from angular-1.5.5-seed dist)
  //
  ...
  .directive('weatherPanel',[function factory() {
    return {
      ...
      templateUrl: 'partials/_weather-cards-light.html',
...
.directive('weatherPanelWind',[function factory() {
  return {
    ...
    templateUrl: 'partials/_weather-card-storm-wind.html',
